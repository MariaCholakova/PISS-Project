...
INSERT INTO products (product_price, product_name, product_sex, count_available, description, image) VALUES ( ROUND(RAND() *  200 +  1, 2), "jeans", "m", 1, "Dolce & Gabbana jeans!", "https://webiconspng.com/wp-content/uploads/2017/09/Jeans-PNG-Image-44263.png" );
...
INSERT INTO products (product_price, product_name, product_sex, count_available, description, image) VALUES ( ROUND(RAND() *  200 +  1, 2), "dress", "m", 3, "Glittery pink dress!", "https://cdn.shopify.com/s/files/1/2605/6882/products/product-image-442076407_530x@2x.jpg?v=1521459033" );
...
INSERT INTO products (product_price, product_name, product_sex, count_available, description, image) VALUES ( ROUND(RAND() *  200 +  1, 2), "jacket", "f", 4, "Men's leather jacket", "https://4.imimg.com/data4/VW/KT/MY-17715579/mens-leather-jacket-500x500.jpg" );
